...
(() => {
  ...
  function applySession(user) {
    ...
    $$('a').forEach(link => {
      ...
      const routes = { 'Home Feed': '/', 'Profile': '/profile', 'Prayer Wall': '/#prayer-wall', 'Find Jobs': '/jobs', 'Find Users': '/network', 'Library': '/library', 'Social Studio': '/bible-study' };
