...
(() => {
  ...
  const NAV = [
    ...
    { id: 'library', href: 'library.html', icon: 'fa-book-open',   label: 'Library' },
    { id: 'network', href: 'network.html', icon: 'fa-user-group',  label: 'Network' },
  ...
  function mountChrome() {
    ...
    header.innerHTML = `
      <div class="max-w-[1200px] mx-auto h-[56px] px-3 sm:px-4 flex items-center gap-3">
        ...
        <a href="index.html" class="flex items-center gap-1.5 shrink-0 text-brand" aria-label="Faith In home">
        ...
        <div class="flex items-center gap-1 ml-auto lg:ml-0">
          ...
          <a href="notifications.html" class="icon-btn relative ${bellActive ? '!bg-brand !text-white dark:!text-[#0b1120]' : ''}" aria-label="Notifications, 3 unread"${bellActive ? ' aria-current="page"' : ''}>
          ...
          <div class="relative ml-1" data-menu-root>
            ...
            <div class="absolute right-0 mt-2 w-60 card shadow-pop p-1.5 hidden animate-pop-in" data-menu role="menu">
              ...
              <a href="profile.html" class="side-link${page === 'profile' ? ' is-active' : ''}" role="menuitem"><i class="fa-regular fa-user"></i>View profile</a>
              <a href="#" class="side-link" role="menuitem"><i class="fa-solid fa-bookmark"></i>Saved items</a>
              <a href="settings.html" class="side-link${page === 'settings' ? ' is-active' : ''}" role="menuitem"><i class="fa-solid fa-gear"></i>Settings</a>
    ...
    tabs.innerHTML = `
      <div class="grid grid-cols-5 h-14">
        <a href="index.html" class="top-link min-w-0"${page === 'home' ? ' aria-current="page"' : ''}><i class="fa-solid fa-house"></i>Home</a>
        <a href="network.html" class="top-link min-w-0"${page === 'network' ? ' aria-current="page"' : ''}><i class="fa-solid fa-user-group"></i>Network</a>
        <button class="grid place-items-center" data-modal-open="modal-blessing" data-fallback="index.html" aria-label="Add blessing">
        ...
        <a href="jobs.html" class="top-link min-w-0"${page === 'jobs' ? ' aria-current="page"' : ''}><i class="fa-solid fa-briefcase"></i>Jobs</a>
        <a href="library.html" class="top-link min-w-0"${page === 'library' ? ' aria-current="page"' : ''}><i class="fa-solid fa-book-open"></i>Library</a>
      </div>`;
